  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Тренировка ритма",style: TextStyle(fontFamily: 'Trajan Pro'),),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const Text("Теория",style: TextStyle(fontFamily: 'Trajan Pro'),),
            SizedBox(
              height: MediaQuery.of(context).size.height * 0.05,
            ),
            SizedBox(
            ...
            const Text("Метроном",style: TextStyle(fontFamily: 'Trajan Pro'),),
          ],
        ),
      ),
    );
